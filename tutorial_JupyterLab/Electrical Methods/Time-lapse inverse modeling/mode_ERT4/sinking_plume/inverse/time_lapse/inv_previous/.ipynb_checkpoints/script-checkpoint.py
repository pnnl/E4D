...
@author: robi526
""" 
# define log10 and log difference with baseline
DefineScalarExpression("log10", "log10(Real_conductivity)")
DefineScalarExpression("log_diff", "(conn_cmfe(<[0]i:log10>, <mesh>)-log10)")
...
v = GetView3D()
print ("The view is: ", v)
v.viewNormal = (-0.4, -0.90, 0.4)
v.viewUp = (0.1, 0.37, 0.92)
SetView3D(v)

View3DAtts = View3DAttributes()
View3DAtts.viewNormal = (-0.4, -0.90, 0.4)
View3DAtts.focus = (0, 3, -5)
View3DAtts.viewUp = (0.1, 0.37, 0.92)
View3DAtts.viewAngle = 30
View3DAtts.parallelScale = 9.9
View3DAtts.nearPlane = -19.799
View3DAtts.farPlane = 19.799
